...
class EfemerideForm(forms.ModelForm):
    class Meta:
        model = Efemeride
        fields = ['titulo', 'fecha', 'fecha_hasta', 'responsable', 'descripcion']
        widgets = {
            ...
            'fecha_hasta': forms.DateInput(attrs={'type': 'date', 'class': 'w-full px-4 py-3 bg-gray-50 border-none rounded-xl text-sm font-bold text-gray-700 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none'}),
