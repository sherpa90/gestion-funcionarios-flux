...
ACCOUNT_ALLOW_EMAIL_AUTH = True

# Redirect for social auth
...
SESSION_COOKIE_SECURE = not DEBUG and os.environ.get('SESSION_COOKIE_SECURE', 'True').lower() in ('true', '1', 'yes', 'on')
CSRF_COOKIE_SECURE = not DEBUG and os.environ.get('CSRF_COOKIE_SECURE', 'True').lower() in ('true', '1', 'yes', 'on')
CSRF_COOKIE_HTTPONLY = True
SECURE_SSL_REDIRECT = not DEBUG and os.environ.get('SECURE_SSL_REDIRECT', 'True').lower() in ('true', '1', 'yes', 'on')
